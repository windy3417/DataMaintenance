...
namespace DataMaintenance.DAL.ViewServices.U8services
{
   public class BoxIDExistService
    {
        public DataTable GetCurrentStock(Func<CurrentStock, Boolean> headerFilter, Func<rdrecord10, Boolean> funcDetail,string accountNo)
        ...
        public DataTable GetBoxIdExist(string invCode,DateTime stockInDate,string accountNo)
        {
